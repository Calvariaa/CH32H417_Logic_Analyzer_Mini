...
const uint8_t MyCfgDescr_HS[] = 
{
    ...
    (uint8_t)(DEF_USB_EP1_HS_SIZE >> 8),    // wMaxPacketSize 512
    ...
    0x02,                                   // bmAttributes (Bulk)
    (uint8_t)DEF_USB_EP2_HS_SIZE,
    (uint8_t)(DEF_USB_EP2_HS_SIZE >> 8),    // wMaxPacketSize 512
    0x00,                                   // bInterval 0 (unit depends on device speed)
    ...
    0x02,                                   // bmAttributes (Bulk)
    (uint8_t)DEF_USB_EP3_HS_SIZE,
    (uint8_t)(DEF_USB_EP3_HS_SIZE >> 8),    // wMaxPacketSize 512
    0x00,                                   // bInterval 0 (unit depends on device speed)
...
const uint8_t MyCfgDescr_FS[] = 
{
    ...
    (uint8_t)(DEF_USB_EP1_FS_SIZE >> 8),    // wMaxPacketSize 64
    0x00,                                   // bInterval 0 (unit depends on device speed)
    ...
    (uint8_t)(DEF_USB_EP2_FS_SIZE >> 8),    // wMaxPacketSize 64
    0x00,                                   // bInterval 0 (unit depends on device speed)
    ...
    0x03,                                   // bEndpointAddress (OUT/H2D)
    0x02,                                   // bmAttributes (Bulk)
    (uint8_t)DEF_USB_EP3_FS_SIZE,
    (uint8_t)(DEF_USB_EP3_FS_SIZE >> 8),    // wMaxPacketSize 64
    0x00,                                   // bInterval 0 (unit depends on device speed)
...
const uint8_t SS_DeviceDescriptor[] = 
{
    ...
    (uint8_t)DEF_USB_VID,
    (uint8_t)(DEF_USB_VID >> 8),        // idVendor
    (uint8_t)DEF_USB30_PID,
    (uint8_t)(DEF_USB30_PID >> 8),      // idProduct
    DEF_IC_PRG_VER,
    0x00,                               // bcdDevice
    0x01,                               // iManufacturer
    0x02,                               // iProduct
